...
E2E_REQUIRED_MEASURE_PYTHON_PARITY_CPP_ENV := env_var_or_default("E2E_REQUIRED_MEASURE_PYTHON_PARITY_CPP_ENV", E2E_REQUIRED_SPLIT_CPP_ENV)
...
e2e-required-measure out=E2E_REQUIRED_MEASURE_OUT:
    ...
    E2E_REQUIRED_PYTHON_PARITY_CPP_ENV="{{ E2E_REQUIRED_MEASURE_PYTHON_PARITY_CPP_ENV }}" \
