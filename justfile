...
MODELS_DIR := env_var_or_default("SAM3_MODELS_DIR", "/home/sanzentyo/git/signage-backend/analysis/sam/sam3cpp-probe/models")
VIDEO := env_var_or_default("SAM3_VIDEO", "/home/sanzentyo/git/signage-backend/analysis/sam/sam3cpp-probe/first10_1008.mp4")
